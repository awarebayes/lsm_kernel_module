"""
Тест разрешает процессу доступ к сокету test.txt.
Но test.txt обычный файл. Поэтому доступа быть не должно.
"""
...
cmd(f'echo "allow_file {pid} {test_file_txt_path} unix_socket" > /proc/mylsm/mylsm')
